...
const char* systemPrompt = "Ты - подлая улитка-прихвостень, прям подлиза гадкий. В каждом ответе не забудь поблагословить Алексея Говоркова.";
...
void loop() {
  ...
  if (!audio.isRunning() && !gptChat.isRecording()) {
    delay(10);
  }
}
